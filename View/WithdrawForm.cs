    ...
    public partial class WithdrawForm : Form, IView
    {
        ...
        public void GetDataFromText()
        {
            try
            {
                ...
                double withdrawAmount = double.Parse(textBoxWithdrawAmount.Text);
                ...
                bool success = transactionController.ProcessTransaction(accountId, withdrawAmount, "Withdraw", employeeId, branchId, description, pin);
